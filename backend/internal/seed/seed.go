...
func DevOpsCourse() CourseSeed {
	return CourseSeed{
		...
		Description: "Полный практический курс для тех, кто хочет собирать, доставлять и эксплуатировать " +
			"приложения как инженер DevOps. Одиннадцать модулей от командной строки до Kubernetes, мониторинга " +
			"и безопасности: в каждом — теория со ссылками на первоисточники, тренажёр терминала, практика " +
			"с конфигурациями и квиз с проверкой на сервере. " +
