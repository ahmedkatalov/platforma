		...
		Lessons: []LessonSeed{
			{
				...
				Content: map[string]any{
					"body": "## Зачем это нужно\n\n" +
						...
						"Та же мысль на примере. Плохо — пароль вписан прямо в код:\n" +
						"\n" +
						"```python\n" +
						"db_password = \"supersecret\"        # так нельзя\n" +
						"```\n" +
						"\n" +
						"Хорошо — пароль приходит из окружения:\n" +
						"\n" +
						"```python\n" +
						"import os\n" +
						"db_password = os.environ[\"DB_PASSWORD\"]   # значение задаётся снаружи\n" +
						"```\n" +
						"\n" +
			...
			},
			{
				...
				Content: map[string]any{
					"body": "## Зачем это нужно\n\n" +
						...
						"├────────────┼────────────────┼──────────┼───────────────┼───────────────┤\n" +
						"│ libcrypto3 │ CVE-2024-XXXXX │ CRITICAL │ 3.3.0-r0      │ 3.3.1-r0      │\n" +
						"│ curl       │ CVE-2024-YYYYY │ HIGH     │ 8.7.1-r0      │ 8.8.0-r0      │\n" +
						"└────────────┴────────────────┴──────────┴───────────────┴───────────────┘\n" +
						"```\n" +
						"\n" +
						"Severity — насколько опасно. Fixed Version — до какой версии обновиться, чтобы закрыть дыру.\n" +
						"\n" +
