...
func moduleExam() ModuleSeed {
	return ModuleSeed{
		...
		Lessons: []LessonSeed{
			{
				Title:       "Что вас ждёт и как подготовиться",
				Kind:        "text",
				Summary:     "Три части аттестации и короткий план повторения",
				DurationMin: 7,
				Content: map[string]any{
					"body": "## Три части\n\n" +
						"1. **Экзамен.** Двенадцать вопросов по всем темам. Порог выше обычного — 80%.\n" +
						"2. **Диагностика.** Тренажёр: находите причину сбоя от жалобы пользователя до откатa.\n" +
						"3. **Практика.** Собираете манифест развёртывания, готовый к боевому применению.\n\n" +
						"Проходить можно сколько угодно раз. Задача — не сдать с первого раза, а разобраться.\n\n" +
						"## Что повторить перед экзаменом\n\n" +
						"| Тема | Ключевое |\n" +
						"|---|---|\n" +
						"| Linux | права 600/644/755, чтение логов, `df -h` при непонятной поломке |\n" +
						"| Git | ветка на задачу, `revert` вместо `reset` в общей ветке |\n" +
						"| Сети | 500 против 502, `nginx -t` перед перезагрузкой |\n" +
						"| Docker | образ и контейнер, тома, версия вместо `latest` |\n" +
						"| CI/CD | порядок шагов, секреты, окружения |\n" +
						"| IaC | план перед применением, идемпотентность |\n" +
						"| Kubernetes | readiness и liveness, `logs` и `describe` при проблеме |\n" +
						"| Мониторинг | p95 вместо среднего, выдержка `for` у алерта |\n" +
						"| Безопасность | секреты вне Git, минимум прав |\n\n" +
						"## Как готовиться\n\n" +
						"Не перечитывайте всю теорию подряд. Эффективнее так:\n\n" +
						"1. Пройдите заново тренажёры тех модулей, где путались.\n" +
						"2. Перечитайте блоки «Запомнить» — это выжимка каждого урока.\n" +
						"3. Пройдите модульные квизы ещё раз: они короче экзамена и показывают пробелы.\n\n" +
						"## После аттестации\n\n" +
						"Когда все уроки курса пройдены, платформа выдаёт сертификат с уникальным номером " +
						"и публичной страницей проверки. Ссылку можно отправить работодателю.\n\n" +
						"Дальше есть два разумных направления:\n\n" +
						"- **Вглубь Kubernetes** — программа сертификации CKA как ориентир.\n" +
						"- **В облака** — управляемые сервисы, сети, стоимость.\n\n" +
						"И главное: соберите свой маленький проект. Приложение, база, конвейер сборки, " +
						"выкат в кластер. Один такой проект на собеседовании весит больше десяти курсов.",
					"resources": []map[string]any{
						{
							"title": "Программа сертификации CKA",
							"url":   "https://github.com/cncf/curriculum",
							"note":  "официальный список тем — ориентир, куда двигаться дальше",
						},
						{
							"title": "roadmap.sh — DevOps Roadmap",
							"url":   "https://roadmap.sh/devops",
							"note":  "карта следующих шагов",
						},
						{
